...
class MobileCommentsSpider(scrapy.Spider):
    name = 'mobile_comments_spider'
    i = 0
    # sort by most visited by default
    start_urls = ['https://www.digikala.com/search/category-mobile-phone/?sortby=4']
    ...
    def parse(self, response):
        ...
        if next_page < 101 and next_page_url is not None:
