...
class HeadsetCommentsSpider(scrapy.Spider):
    name = 'headset_comments_spider'
    i = 0
    # sort by most visited by default
    start_urls = ['https://www.digikala.com/search/category-headphone-headset-microphone/?sortby=7']
    ...
    def parse_product(self, response):
        ...
        category = product_title.strip().split(' ')[0]
